...
const planes = [
  {
    ...
    precio: "6,540 MXN + IVA",
    descripcion: "Control de inventario básico, alertas de stock, reportes simples.",
    icono: Package,
    caracteristicas: [
  ...
  {
    id: 302,
    nombre: "Sistema Intermedio",
    precio: "14,920 MXN + IVA",
    descripcion: "Integración con otros sistemas, reportes personalizados, seguimiento de pedidos.",
    icono: Layers,
    caracteristicas: [
      "Integración con otros sistemas",
      "Reportes personalizados",
      "Seguimiento de pedidos",
      "Código de barras/QRCódigos de barras/QR",
  ...
  },
  {
    ...
    precio: "28,310 MXN + IVA",
    descripcion: "Integración completa con otros sistemas, automatización de procesos logísticos, soporte técnico.",
    icono: Zap,
    caracteristicas: [
    ...
    if (plan) {
      ...
      if (!existe) {
        carritoActual.push({
          ...
          nombre: plan.nombre,
          precio: plan.precio,
          tipo: "Sistemas de Inventario y Logística",
          cantidad: 1,
      ...
      <section className="relative overflow-hidden pt-32 pb-20">
        ...
        <div className="container-dm relative">
          <div className="mb-8 flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>/</span>
            <span className="text-white">Sistemas de Inventario y Logística</span>
          </div>

          <div className="text-center">
            <h1 className="font-display text-4xl font-bold text-white sm:text-5xl lg:text-6xl">
              Sistemas de <span className="text-primary">Inventario y Logística</span>
            </h1>
          ...
          <div className="mt-12 flex justify-center">
            <div className="relative">
              ...
              <img
                ...
                alt="Inventario y logística Klyro"
            ...
            <div className="relative grid grid-cols-1 items-center gap-10 p-8 md:grid-cols-2 md:p-12 lg:p-16">
              <div className="z-10">
                ...
                <p className="mt-4 max-w-md text-muted-foreground">
                  Optimiza tu inventario y logística con soluciones a la medida. Sin compromisos.
                </p>
              ...
              <div className="relative z-10 flex justify-center">
                <div className="relative">
                  <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-primary/20 to-emerald-500/20 blur-3xl" />
                  <img
                    src="https://images.unsplash.com/photo-1566576912321-d58ddd7a6088?w=300&h=300&fit=crop"
